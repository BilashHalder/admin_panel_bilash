                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link" id="home-tab" data-bs-toggle="tab" href="#home-1" role="tab" aria-controls="home" aria-selected="false">Home</a>
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" id="contact-tab" data-bs-toggle="tab" href="#contact-1" role="tab" aria-controls="contact" aria-selected="true">Contact</a>
                      </li>
                    </ul>
                      ...
                      <div class="col-lg-9 col-xl-6">
                        <div class="tab-content tab-content-vertical tab-content-vertical-custom">
                          <div class="tab-pane fade show active" id="home-3" role="tabpanel" aria-labelledby="home-tab">
                            <h6 class="font-weight-normal pt-3 pt-lg-0">Profiles Of The Powerful Advertising Exec Steve Grasse</h6>
