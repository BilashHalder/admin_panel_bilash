    ...
    <div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between flex-wrap">
                      <div>
                        <div class="card-title mb-0">My Profit</div>
                        ...
                        <div class="d-flex flex-wrap pt-2 justify-content-between sales-header-right">
                          <div class="d-flex mr-5">
                            ...
                            <div class="pl-2">
                              ...
                              <span class="font-10 font-weight-semibold text-muted">TOTAL INVESMENT</span>
                            </div>
                          </div>
            ...
            {/* <div class="row">
              <div class="col-sm-4 stretch-card grid-margin">
                <ImageWithCard img="./assets/images/dashboard/img_1.jpg" heading="ENTIRE APARTMENT" subhead="Cosy Studio flat in London" rating="4.60 (35)" price="$5,267/night"/>
              </div>
              <div class="col-sm-4 stretch-card grid-margin">
              <ImageWithCard img="./assets/images/dashboard/img_2.jpg" heading="ENTIRE APARTMENT" subhead="Victoria Bedsit Studio Ensuite" rating="4.83 (12)" price="$6,144/night"/>
              </div>
              <div class="col-sm-4 stretch-card grid-margin">
              <ImageWithCard img="./assets/images/dashboard/img_3.jpg" heading="ENTIRE APARTMENT" subhead="Fabulous Huge Room" rating="3.83 (15)" price="$5,267/night"/>
              </div>
            </div> */}
              ...
              <div class="col-xl-8 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body pb-0">
                    <h4 class="card-title mb-0">Our Top 10 Investor</h4>
                  </div>
